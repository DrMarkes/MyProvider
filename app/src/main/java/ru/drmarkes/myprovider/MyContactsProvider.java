package ru.drmarkes.myprovider;
...
public class MyContactsProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "ru.drmarkes.myprovider.AdressBook";
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        Cursor cursor = db.query(CONTACT_TABLE, projection, selection, selectionArgs, null, null,
                sortOrder);
